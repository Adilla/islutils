...
public:
  ...
  inline aff add_coefficient_si(isl::checked::dim type, int pos, int v) const;
  inline aff add_coefficient_val(isl::checked::dim type, int pos, val v) const;
  inline aff add_constant_num_si(int v) const;
  inline aff add_constant_si(int v) const;
  inline aff add_constant_val(val v) const;
  inline aff add_dims(isl::checked::dim type, unsigned int n) const;
  inline aff align_params(space model) const;
  inline aff ceil() const;
  inline int coefficient_sgn(isl::checked::dim type, int pos) const;
  inline int dim(isl::checked::dim type) const;
  inline aff div(aff aff2) const;
  inline aff drop_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline basic_set eq_basic_set(aff aff2) const;
  inline set eq_set(aff aff2) const;
  inline val eval(point pnt) const;
  inline int find_dim_by_name(isl::checked::dim type, const std::string &name) const;
  ...
  inline val get_coefficient_val(isl::checked::dim type, int pos) const;
  inline val get_constant_val() const;
  inline val get_denominator_val() const;
  inline std::string get_dim_name(isl::checked::dim type, unsigned int pos) const;
  ...
  inline aff insert_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline boolean involves_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  ...
  inline aff move_dims(isl::checked::dim dst_type, unsigned int dst_pos, isl::checked::dim src_type, unsigned int src_pos, unsigned int n) const;
  ...
  inline aff set_coefficient_si(isl::checked::dim type, int pos, int v) const;
  inline aff set_coefficient_val(isl::checked::dim type, int pos, val v) const;
  inline aff set_constant_si(int v) const;
  inline aff set_constant_val(val v) const;
  inline aff set_dim_id(isl::checked::dim type, unsigned int pos, id id) const;
  inline aff set_tuple_id(isl::checked::dim type, id id) const;
  inline aff sub(aff aff2) const;
  static inline aff var_on_domain(local_space ls, isl::checked::dim type, unsigned int pos);
...
public:
  ...
  inline basic_map add_dims(isl::checked::dim type, unsigned int n) const;
  ...
  inline unsigned int dim(isl::checked::dim type) const;
  inline basic_set domain() const;
  inline basic_map domain_map() const;
  inline basic_map domain_product(basic_map bmap2) const;
  inline basic_map drop_constraints_involving_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline basic_map drop_constraints_not_involving_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline basic_map drop_unused_params() const;
  inline basic_map eliminate(isl::checked::dim type, unsigned int first, unsigned int n) const;
  static inline basic_map empty(space space);
  static inline basic_map equal(space dim, unsigned int n_equal);
  inline mat equalities_matrix(isl::checked::dim c1, isl::checked::dim c2, isl::checked::dim c3, isl::checked::dim c4, isl::checked::dim c5) const;
  inline basic_map equate(isl::checked::dim type1, int pos1, isl::checked::dim type2, int pos2) const;
  inline int find_dim_by_name(isl::checked::dim type, const std::string &name) const;
  inline basic_map fix_si(isl::checked::dim type, unsigned int pos, int value) const;
  inline basic_map fix_val(isl::checked::dim type, unsigned int pos, val v) const;
  ...
  inline local_space get_local_space() const;
  inline space get_space() const;
  inline std::string get_tuple_name(isl::checked::dim type) const;
  inline basic_map gist(basic_map context) const;
  inline basic_map gist_domain(basic_set context) const;
  inline boolean has_dim_id(isl::checked::dim type, unsigned int pos) const;
  static inline basic_map identity(space dim);
  inline boolean image_is_bounded() const;
  inline mat inequalities_matrix(isl::checked::dim c1, isl::checked::dim c2, isl::checked::dim c3, isl::checked::dim c4, isl::checked::dim c5) const;
  inline basic_map insert_dims(isl::checked::dim type, unsigned int pos, unsigned int n) const;
  ...
  inline basic_map lower_bound_si(isl::checked::dim type, unsigned int pos, int value) const;
  static inline basic_map more_at(space dim, unsigned int pos);
  inline basic_map move_dims(isl::checked::dim dst_type, unsigned int dst_pos, isl::checked::dim src_type, unsigned int src_pos, unsigned int n) const;
  inline int n_constraint() const;
  static inline basic_map nat_universe(space dim);
  inline basic_map neg() const;
  inline basic_map order_ge(isl::checked::dim type1, int pos1, isl::checked::dim type2, int pos2) const;
  inline basic_map order_gt(isl::checked::dim type1, int pos1, isl::checked::dim type2, int pos2) const;
  inline val plain_get_val_if_fixed(isl::checked::dim type, unsigned int pos) const;
  ...
  inline basic_map project_out(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline basic_set range() const;
  inline basic_map range_map() const;
  inline basic_map range_product(basic_map bmap2) const;
  inline basic_map remove_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline basic_map remove_divs() const;
  inline basic_map remove_divs_involving_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline basic_map remove_redundancies() const;
  inline basic_map reverse() const;
  inline basic_map sample() const;
  inline basic_map set_tuple_id(isl::checked::dim type, id id) const;
  inline basic_map set_tuple_name(isl::checked::dim type, const std::string &s) const;
  ...
  inline basic_map upper_bound_si(isl::checked::dim type, unsigned int pos, int value) const;
...
public:
  ...
  inline basic_set drop_constraints_involving_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline basic_set drop_constraints_not_involving_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline basic_set drop_unused_params() const;
  inline basic_set eliminate(isl::checked::dim type, unsigned int first, unsigned int n) const;
  static inline basic_set empty(space space);
  inline mat equalities_matrix(isl::checked::dim c1, isl::checked::dim c2, isl::checked::dim c3, isl::checked::dim c4) const;
  inline basic_set fix_si(isl::checked::dim type, unsigned int pos, int value) const;
  inline basic_set fix_val(isl::checked::dim type, unsigned int pos, val v) const;
  inline basic_set flat_product(basic_set bset2) const;
  inline basic_set flatten() const;
  inline stat foreach_bound_pair(isl::checked::dim type, unsigned int pos, const std::function<stat(constraint, constraint, basic_set)> &fn) const;
  inline stat foreach_constraint(const std::function<stat(constraint)> &fn) const;
  ...
  inline constraint_list get_constraint_list() const;
  inline id get_dim_id(isl::checked::dim type, unsigned int pos) const;
  inline std::string get_dim_name(isl::checked::dim type, unsigned int pos) const;
  inline aff get_div(int pos) const;
  inline local_space get_local_space() const;
  inline space get_space() const;
  ...
  inline mat inequalities_matrix(isl::checked::dim c1, isl::checked::dim c2, isl::checked::dim c3, isl::checked::dim c4) const;
  inline basic_set insert_dims(isl::checked::dim type, unsigned int pos, unsigned int n) const;
  ...
  inline basic_set lower_bound_val(isl::checked::dim type, unsigned int pos, val value) const;
  inline val max_val(const aff &obj) const;
  inline basic_set move_dims(isl::checked::dim dst_type, unsigned int dst_pos, isl::checked::dim src_type, unsigned int src_pos, unsigned int n) const;
  inline int n_constraint() const;
  ...
  inline basic_set project_out(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline mat reduced_basis() const;
  inline basic_set remove_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline basic_set remove_divs() const;
  inline basic_set remove_divs_involving_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  ...
  inline basic_set upper_bound_val(isl::checked::dim type, unsigned int pos, val value) const;
};
...
public:
  ...
  inline aff get_bound(isl::checked::dim type, int pos) const;
  inline val get_coefficient_val(isl::checked::dim type, int pos) const;
  inline val get_constant_val() const;
  inline std::string get_dim_name(isl::checked::dim type, unsigned int pos) const;
  inline aff get_div(int pos) const;
  ...
  inline boolean is_lower_bound(isl::checked::dim type, unsigned int pos) const;
  inline boolean is_upper_bound(isl::checked::dim type, unsigned int pos) const;
  inline int plain_cmp(const constraint &c2) const;
  inline constraint set_coefficient_si(isl::checked::dim type, int pos, int v) const;
  inline constraint set_coefficient_val(isl::checked::dim type, int pos, val v) const;
...
public:
  ...
  inline local_space add_dims(isl::checked::dim type, unsigned int n) const;
  inline int dim(isl::checked::dim type) const;
  inline local_space domain() const;
  inline local_space drop_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline int find_dim_by_name(isl::checked::dim type, const std::string &name) const;
  ...
  inline space get_space() const;
  inline boolean has_dim_id(isl::checked::dim type, unsigned int pos) const;
  inline boolean has_dim_name(isl::checked::dim type, unsigned int pos) const;
  inline local_space insert_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  ...
  inline local_space set_dim_id(isl::checked::dim type, unsigned int pos, id id) const;
  inline local_space set_from_params() const;
  inline local_space set_tuple_id(isl::checked::dim type, id id) const;
...
public:
  ...
  inline map add_dims(isl::checked::dim type, unsigned int n) const;
  inline basic_map affine_hull() const;
  ...
  inline map drop_constraints_involving_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline map drop_constraints_not_involving_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline map drop_unused_params() const;
  inline map eliminate(isl::checked::dim type, unsigned int first, unsigned int n) const;
  static inline map empty(space space);
  inline map equate(isl::checked::dim type1, int pos1, isl::checked::dim type2, int pos2) const;
  inline map factor_domain() const;
  inline map factor_range() const;
  inline int find_dim_by_id(isl::checked::dim type, const id &id) const;
  inline int find_dim_by_name(isl::checked::dim type, const std::string &name) const;
  inline map fix_si(isl::checked::dim type, unsigned int pos, int value) const;
  inline map fix_val(isl::checked::dim type, unsigned int pos, val v) const;
  ...
  inline space get_space() const;
  inline id get_tuple_id(isl::checked::dim type) const;
  inline std::string get_tuple_name(isl::checked::dim type) const;
  ...
  inline boolean has_tuple_id(isl::checked::dim type) const;
  inline boolean has_tuple_name(isl::checked::dim type) const;
  static inline map identity(space dim);
  inline map insert_dims(isl::checked::dim type, unsigned int pos, unsigned int n) const;
  ...
  inline map lexmin() const;
  inline pw_multi_aff lexmin_pw_multi_aff() const;
  inline map lower_bound_si(isl::checked::dim type, unsigned int pos, int value) const;
  inline map move_dims(isl::checked::dim dst_type, unsigned int dst_pos, isl::checked::dim src_type, unsigned int src_pos, unsigned int n) const;
  inline int n_basic_map() const;
  static inline map nat_universe(space dim);
  inline map neg() const;
  inline map oppose(isl::checked::dim type1, int pos1, isl::checked::dim type2, int pos2) const;
  inline map order_ge(isl::checked::dim type1, int pos1, isl::checked::dim type2, int pos2) const;
  inline map order_gt(isl::checked::dim type1, int pos1, isl::checked::dim type2, int pos2) const;
  inline map order_le(isl::checked::dim type1, int pos1, isl::checked::dim type2, int pos2) const;
  inline map order_lt(isl::checked::dim type1, int pos1, isl::checked::dim type2, int pos2) const;
  ...
  inline map project_out(isl::checked::dim type, unsigned int first, unsigned int n) const;
  ...
  inline map remove_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline map remove_divs() const;
  inline map remove_divs_involving_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline map remove_redundancies() const;
  inline map remove_unknown_divs() const;
  inline map reset_tuple_id(isl::checked::dim type) const;
  inline map reset_user() const;
  inline map reverse() const;
  inline basic_map sample() const;
  inline map set_dim_id(isl::checked::dim type, unsigned int pos, id id) const;
  inline map set_tuple_id(isl::checked::dim type, id id) const;
  inline map set_tuple_name(isl::checked::dim type, const std::string &s) const;
  ...
  inline map upper_bound_si(isl::checked::dim type, unsigned int pos, int value) const;
...
public:
  ...
  inline multi_aff add_dims(isl::checked::dim type, unsigned int n) const;
  inline multi_aff align_params(space model) const;
  inline unsigned int dim(isl::checked::dim type) const;
  static inline multi_aff domain_map(space space);
  inline multi_aff drop_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  ...
  inline multi_aff insert_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline boolean involves_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  ...
  inline multi_aff move_dims(isl::checked::dim dst_type, unsigned int dst_pos, isl::checked::dim src_type, unsigned int src_pos, unsigned int n) const;
  ...
  static inline multi_aff project_out_map(space space, isl::checked::dim type, unsigned int first, unsigned int n);
  ...
  inline multi_aff reset_tuple_id(isl::checked::dim type) const;
  ...
  inline multi_aff set_dim_id(isl::checked::dim type, unsigned int pos, id id) const;
  inline multi_aff set_tuple_id(isl::checked::dim type, id id) const;
  inline multi_aff set_tuple_name(isl::checked::dim type, const std::string &s) const;
...
public:
  ...
  inline multi_pw_aff add_dims(isl::checked::dim type, unsigned int n) const;
  inline multi_pw_aff align_params(space model) const;
  inline multi_pw_aff coalesce() const;
  inline unsigned int dim(isl::checked::dim type) const;
  inline set domain() const;
  inline multi_pw_aff drop_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  ...
  inline multi_pw_aff insert_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  ...
  inline multi_pw_aff move_dims(isl::checked::dim dst_type, unsigned int dst_pos, isl::checked::dim src_type, unsigned int src_pos, unsigned int n) const;
  ...
  inline multi_pw_aff reset_tuple_id(isl::checked::dim type) const;
  ...
  inline multi_pw_aff set_dim_id(isl::checked::dim type, unsigned int pos, id id) const;
  inline multi_pw_aff set_pw_aff(int pos, pw_aff el) const;
  inline multi_pw_aff set_tuple_id(isl::checked::dim type, id id) const;
  inline multi_pw_aff set_tuple_name(isl::checked::dim type, const std::string &s) const;
...
public:
  ...
  inline multi_union_pw_aff drop_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  ...
  inline multi_union_pw_aff reset_tuple_id(isl::checked::dim type) const;
  ...
  inline multi_union_pw_aff set_dim_id(isl::checked::dim type, unsigned int pos, id id) const;
  inline multi_union_pw_aff set_tuple_id(isl::checked::dim type, id id) const;
  inline multi_union_pw_aff set_tuple_name(isl::checked::dim type, const std::string &s) const;
...
public:
  ...
  inline multi_val add_dims(isl::checked::dim type, unsigned int n) const;
  inline multi_val add_val(val v) const;
  inline multi_val align_params(space model) const;
  inline unsigned int dim(isl::checked::dim type) const;
  inline multi_val drop_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  ...
  inline boolean has_tuple_id(isl::checked::dim type) const;
  inline multi_val insert_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline boolean involves_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline boolean involves_nan() const;
  ...
  inline multi_val reset_tuple_id(isl::checked::dim type) const;
  ...
  inline multi_val set_dim_id(isl::checked::dim type, unsigned int pos, id id) const;
  inline multi_val set_tuple_id(isl::checked::dim type, id id) const;
  inline multi_val set_tuple_name(isl::checked::dim type, const std::string &s) const;
...
public:
  ...
  inline point add_ui(isl::checked::dim type, int pos, unsigned int val) const;
  inline val get_coordinate_val(isl::checked::dim type, int pos) const;
  inline space get_space() const;
  inline point set_coordinate_val(isl::checked::dim type, int pos, val v) const;
  inline point sub_ui(isl::checked::dim type, int pos, unsigned int val) const;
};
...
public:
  ...
  inline pw_aff add_dims(isl::checked::dim type, unsigned int n) const;
  ...
  inline set domain() const;
  inline pw_aff drop_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  ...
  inline boolean has_dim_id(isl::checked::dim type, unsigned int pos) const;
  inline boolean has_tuple_id(isl::checked::dim type) const;
  inline pw_aff insert_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  ...
  inline pw_aff move_dims(isl::checked::dim dst_type, unsigned int dst_pos, isl::checked::dim src_type, unsigned int src_pos, unsigned int n) const;
  ...
  inline pw_aff reset_tuple_id(isl::checked::dim type) const;
  inline pw_aff reset_user() const;
  inline pw_aff scale(val v) const;
  inline pw_aff scale_down(val f) const;
  inline pw_aff set_dim_id(isl::checked::dim type, unsigned int pos, id id) const;
  inline pw_aff set_tuple_id(isl::checked::dim type, id id) const;
  ...
  static inline pw_aff var_on_domain(local_space ls, isl::checked::dim type, unsigned int pos);
...
public:
  ...
  inline unsigned int dim(isl::checked::dim type) const;
  inline set domain() const;
  inline pw_multi_aff drop_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline pw_multi_aff drop_unused_params() const;
  static inline pw_multi_aff empty(space space);
  inline int find_dim_by_name(isl::checked::dim type, const std::string &name) const;
  inline pw_multi_aff fix_si(isl::checked::dim type, unsigned int pos, int value) const;
  ...
  static inline pw_multi_aff project_out_map(space space, isl::checked::dim type, unsigned int first, unsigned int n);
  ...
  inline pw_multi_aff reset_tuple_id(isl::checked::dim type) const;
  ...
  inline pw_multi_aff set_dim_id(isl::checked::dim type, unsigned int pos, id id) const;
  inline pw_multi_aff set_pw_aff(unsigned int pos, pw_aff pa) const;
  inline pw_multi_aff set_tuple_id(isl::checked::dim type, id id) const;
...
public:
  ...
  inline pw_qpolynomial add_dims(isl::checked::dim type, unsigned int n) const;
  static inline pw_qpolynomial alloc(set set, qpolynomial qp);
  inline pw_qpolynomial coalesce() const;
  inline unsigned int dim(isl::checked::dim type) const;
  inline set domain() const;
  inline pw_qpolynomial drop_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline pw_qpolynomial drop_unused_params() const;
  inline val eval(point pnt) const;
  inline int find_dim_by_name(isl::checked::dim type, const std::string &name) const;
  inline pw_qpolynomial fix_val(isl::checked::dim type, unsigned int n, val v) const;
  ...
  inline pw_qpolynomial insert_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  ...
  inline pw_qpolynomial move_dims(isl::checked::dim dst_type, unsigned int dst_pos, isl::checked::dim src_type, unsigned int src_pos, unsigned int n) const;
  ...
  inline pw_qpolynomial split_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
...
public:
  ...
  inline qpolynomial add_dims(isl::checked::dim type, unsigned int n) const;
  ...
  inline unsigned int dim(isl::checked::dim type) const;
  inline qpolynomial drop_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline val eval(point pnt) const;
  inline stat foreach_term(const std::function<stat(term)> &fn) const;
  static inline qpolynomial from_aff(aff aff);
  static inline qpolynomial from_constraint(constraint c, isl::checked::dim type, unsigned int pos);
  ...
  inline qpolynomial insert_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline boolean involves_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline boolean is_infty() const;
  inline boolean is_nan() const;
  inline boolean is_neginfty() const;
  inline boolean is_zero() const;
  inline qpolynomial move_dims(isl::checked::dim dst_type, unsigned int dst_pos, isl::checked::dim src_type, unsigned int src_pos, unsigned int n) const;
  ...
  static inline qpolynomial var_on_domain(space dim, isl::checked::dim type, unsigned int pos);
...
public:
  ...
  inline set add_dims(isl::checked::dim type, unsigned int n) const;
  inline basic_set affine_hull() const;
  ...
  inline unsigned int dim(isl::checked::dim type) const;
  inline boolean dim_has_any_lower_bound(isl::checked::dim type, unsigned int pos) const;
  inline boolean dim_has_any_upper_bound(isl::checked::dim type, unsigned int pos) const;
  inline boolean dim_has_lower_bound(isl::checked::dim type, unsigned int pos) const;
  inline boolean dim_has_upper_bound(isl::checked::dim type, unsigned int pos) const;
  inline boolean dim_is_bounded(isl::checked::dim type, unsigned int pos) const;
  inline pw_aff dim_max(int pos) const;
  inline pw_aff dim_min(int pos) const;
  inline set drop_constraints_involving_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline set drop_constraints_not_involving_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline set drop_unused_params() const;
  inline set eliminate(isl::checked::dim type, unsigned int first, unsigned int n) const;
  static inline set empty(space space);
  inline set equate(isl::checked::dim type1, int pos1, isl::checked::dim type2, int pos2) const;
  inline int find_dim_by_id(isl::checked::dim type, const id &id) const;
  inline int find_dim_by_name(isl::checked::dim type, const std::string &name) const;
  inline set fix_si(isl::checked::dim type, unsigned int pos, int value) const;
  inline set fix_val(isl::checked::dim type, unsigned int pos, val v) const;
  ...
  inline set insert_dims(isl::checked::dim type, unsigned int pos, unsigned int n) const;
  ...
  inline set lexmin() const;
  inline pw_multi_aff lexmin_pw_multi_aff() const;
  inline set lower_bound_si(isl::checked::dim type, unsigned int pos, int value) const;
  inline set lower_bound_val(isl::checked::dim type, unsigned int pos, val value) const;
  inline val max_val(const aff &obj) const;
  inline val min_val(const aff &obj) const;
  inline set move_dims(isl::checked::dim dst_type, unsigned int dst_pos, isl::checked::dim src_type, unsigned int src_pos, unsigned int n) const;
  inline int n_basic_set() const;
  inline unsigned int n_dim() const;
  ...
  inline map project_onto_map(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline set project_out(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline set remove_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline set remove_divs() const;
  inline set remove_divs_involving_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  ...
  inline basic_set sample() const;
  inline point sample_point() const;
  inline set set_dim_id(isl::checked::dim type, unsigned int pos, id id) const;
  inline set set_tuple_id(id id) const;
  inline set set_tuple_name(const std::string &s) const;
  inline basic_set simple_hull() const;
  inline int size() const;
  inline basic_set solutions() const;
  inline set split_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  ...
  inline set upper_bound_si(isl::checked::dim type, unsigned int pos, int value) const;
  inline set upper_bound_val(isl::checked::dim type, unsigned int pos, val value) const;
...
public:
  ...
  inline space add_dims(isl::checked::dim type, unsigned int n) const;
  ...
  inline space drop_dims(isl::checked::dim type, unsigned int first, unsigned int num) const;
  ...
  inline boolean has_tuple_id(isl::checked::dim type) const;
  inline boolean has_tuple_name(isl::checked::dim type) const;
  inline space insert_dims(isl::checked::dim type, unsigned int pos, unsigned int n) const;
  ...
  inline space move_dims(isl::checked::dim dst_type, unsigned int dst_pos, isl::checked::dim src_type, unsigned int src_pos, unsigned int n) const;
  ...
  inline space reset_tuple_id(isl::checked::dim type) const;
  inline space reset_user() const;
  inline space reverse() const;
  inline space set_dim_id(isl::checked::dim type, unsigned int pos, id id) const;
  inline space set_from_params() const;
  inline space set_tuple_id(isl::checked::dim type, id id) const;
  inline space set_tuple_name(isl::checked::dim type, const std::string &s) const;
  inline boolean tuple_is_equal(isl::checked::dim type1, const space &space2, isl::checked::dim type2) const;
...
public:
  ...
  inline int get_exp(isl::checked::dim type, unsigned int pos) const;
};
...
public:
  ...
  inline union_map project_out(isl::checked::dim type, unsigned int first, unsigned int n) const;
...
public:
  ...
  inline unsigned int dim(isl::checked::dim type) const;
  inline union_set domain() const;
  inline union_pw_aff drop_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
...
public:
  ...
  inline unsigned int dim(isl::checked::dim type) const;
  inline union_set domain() const;
  inline union_pw_multi_aff drop_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
...
public:
  ...
  inline unsigned int dim(isl::checked::dim type) const;
  inline union_set domain() const;
  inline union_pw_qpolynomial drop_dims(isl::checked::dim type, unsigned int first, unsigned int n) const;
  inline val eval(point pnt) const;
...
public:
  ...
  inline union_set project_out(isl::checked::dim type, unsigned int first, unsigned int n) const;
...
aff aff::add_coefficient_si(isl::checked::dim type, int pos, int v) const
{
  auto res = isl_aff_add_coefficient_si(copy(), static_cast<enum isl_dim_type>(type), pos, v);
  return manage(res);
}

aff aff::add_coefficient_val(isl::checked::dim type, int pos, val v) const
{
...
aff aff::add_dims(isl::checked::dim type, unsigned int n) const
{
...
int aff::coefficient_sgn(isl::checked::dim type, int pos) const
{
  auto res = isl_aff_coefficient_sgn(get(), static_cast<enum isl_dim_type>(type), pos);
  return res;
}

int aff::dim(isl::checked::dim type) const
{
...
aff aff::drop_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
int aff::find_dim_by_name(isl::checked::dim type, const std::string &name) const
{
...
val aff::get_coefficient_val(isl::checked::dim type, int pos) const
{
...
std::string aff::get_dim_name(isl::checked::dim type, unsigned int pos) const
{
...
aff aff::insert_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
  auto res = isl_aff_insert_dims(copy(), static_cast<enum isl_dim_type>(type), first, n);
  return manage(res);
}

boolean aff::involves_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
aff aff::move_dims(isl::checked::dim dst_type, unsigned int dst_pos, isl::checked::dim src_type, unsigned int src_pos, unsigned int n) const
{
...
aff aff::set_coefficient_si(isl::checked::dim type, int pos, int v) const
{
  auto res = isl_aff_set_coefficient_si(copy(), static_cast<enum isl_dim_type>(type), pos, v);
  return manage(res);
}

aff aff::set_coefficient_val(isl::checked::dim type, int pos, val v) const
{
...
aff aff::set_dim_id(isl::checked::dim type, unsigned int pos, id id) const
{
  auto res = isl_aff_set_dim_id(copy(), static_cast<enum isl_dim_type>(type), pos, id.release());
  return manage(res);
}

aff aff::set_tuple_id(isl::checked::dim type, id id) const
{
...
aff aff::var_on_domain(local_space ls, isl::checked::dim type, unsigned int pos)
{
...
basic_map basic_map::add_dims(isl::checked::dim type, unsigned int n) const
{
...
unsigned int basic_map::dim(isl::checked::dim type) const
{
...
basic_map basic_map::drop_constraints_involving_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
  auto res = isl_basic_map_drop_constraints_involving_dims(copy(), static_cast<enum isl_dim_type>(type), first, n);
  return manage(res);
}

basic_map basic_map::drop_constraints_not_involving_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
basic_map basic_map::eliminate(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
mat basic_map::equalities_matrix(isl::checked::dim c1, isl::checked::dim c2, isl::checked::dim c3, isl::checked::dim c4, isl::checked::dim c5) const
{
...
basic_map basic_map::equate(isl::checked::dim type1, int pos1, isl::checked::dim type2, int pos2) const
{
  auto res = isl_basic_map_equate(copy(), static_cast<enum isl_dim_type>(type1), pos1, static_cast<enum isl_dim_type>(type2), pos2);
  return manage(res);
}

int basic_map::find_dim_by_name(isl::checked::dim type, const std::string &name) const
{
  auto res = isl_basic_map_find_dim_by_name(get(), static_cast<enum isl_dim_type>(type), name.c_str());
  return res;
}

basic_map basic_map::fix_si(isl::checked::dim type, unsigned int pos, int value) const
{
  auto res = isl_basic_map_fix_si(copy(), static_cast<enum isl_dim_type>(type), pos, value);
  return manage(res);
}

basic_map basic_map::fix_val(isl::checked::dim type, unsigned int pos, val v) const
{
...
std::string basic_map::get_dim_name(isl::checked::dim type, unsigned int pos) const
{
...
std::string basic_map::get_tuple_name(isl::checked::dim type) const
{
...
boolean basic_map::has_dim_id(isl::checked::dim type, unsigned int pos) const
{
...
mat basic_map::inequalities_matrix(isl::checked::dim c1, isl::checked::dim c2, isl::checked::dim c3, isl::checked::dim c4, isl::checked::dim c5) const
{
...
basic_map basic_map::insert_dims(isl::checked::dim type, unsigned int pos, unsigned int n) const
{
...
boolean basic_map::involves_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
basic_map basic_map::lower_bound_si(isl::checked::dim type, unsigned int pos, int value) const
{
...
basic_map basic_map::move_dims(isl::checked::dim dst_type, unsigned int dst_pos, isl::checked::dim src_type, unsigned int src_pos, unsigned int n) const
{
...
basic_map basic_map::order_ge(isl::checked::dim type1, int pos1, isl::checked::dim type2, int pos2) const
{
  auto res = isl_basic_map_order_ge(copy(), static_cast<enum isl_dim_type>(type1), pos1, static_cast<enum isl_dim_type>(type2), pos2);
  return manage(res);
}

basic_map basic_map::order_gt(isl::checked::dim type1, int pos1, isl::checked::dim type2, int pos2) const
{
  auto res = isl_basic_map_order_gt(copy(), static_cast<enum isl_dim_type>(type1), pos1, static_cast<enum isl_dim_type>(type2), pos2);
  return manage(res);
}

val basic_map::plain_get_val_if_fixed(isl::checked::dim type, unsigned int pos) const
{
...
basic_map basic_map::project_out(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
basic_map basic_map::remove_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
basic_map basic_map::remove_divs_involving_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
basic_map basic_map::set_tuple_id(isl::checked::dim type, id id) const
{
  auto res = isl_basic_map_set_tuple_id(copy(), static_cast<enum isl_dim_type>(type), id.release());
  return manage(res);
}

basic_map basic_map::set_tuple_name(isl::checked::dim type, const std::string &s) const
{
...
basic_map basic_map::upper_bound_si(isl::checked::dim type, unsigned int pos, int value) const
{
...
unsigned int basic_set::dim(isl::checked::dim type) const
{
...
basic_set basic_set::drop_constraints_involving_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
  auto res = isl_basic_set_drop_constraints_involving_dims(copy(), static_cast<enum isl_dim_type>(type), first, n);
  return manage(res);
}

basic_set basic_set::drop_constraints_not_involving_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
basic_set basic_set::eliminate(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
mat basic_set::equalities_matrix(isl::checked::dim c1, isl::checked::dim c2, isl::checked::dim c3, isl::checked::dim c4) const
{
...
basic_set basic_set::fix_si(isl::checked::dim type, unsigned int pos, int value) const
{
  auto res = isl_basic_set_fix_si(copy(), static_cast<enum isl_dim_type>(type), pos, value);
  return manage(res);
}

basic_set basic_set::fix_val(isl::checked::dim type, unsigned int pos, val v) const
{
...
stat basic_set::foreach_bound_pair(isl::checked::dim type, unsigned int pos, const std::function<stat(constraint, constraint, basic_set)> &fn) const
{
  struct fn_data {
...
id basic_set::get_dim_id(isl::checked::dim type, unsigned int pos) const
{
  auto res = isl_basic_set_get_dim_id(get(), static_cast<enum isl_dim_type>(type), pos);
  return manage(res);
}

std::string basic_set::get_dim_name(isl::checked::dim type, unsigned int pos) const
{
...
mat basic_set::inequalities_matrix(isl::checked::dim c1, isl::checked::dim c2, isl::checked::dim c3, isl::checked::dim c4) const
{
...
basic_set basic_set::insert_dims(isl::checked::dim type, unsigned int pos, unsigned int n) const
{
...
boolean basic_set::involves_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
basic_set basic_set::lower_bound_val(isl::checked::dim type, unsigned int pos, val value) const
{
...
basic_set basic_set::move_dims(isl::checked::dim dst_type, unsigned int dst_pos, isl::checked::dim src_type, unsigned int src_pos, unsigned int n) const
{
...
basic_set basic_set::project_out(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
basic_set basic_set::remove_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
basic_set basic_set::remove_divs_involving_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
basic_set basic_set::upper_bound_val(isl::checked::dim type, unsigned int pos, val value) const
{
...
aff constraint::get_bound(isl::checked::dim type, int pos) const
{
  auto res = isl_constraint_get_bound(get(), static_cast<enum isl_dim_type>(type), pos);
  return manage(res);
}

val constraint::get_coefficient_val(isl::checked::dim type, int pos) const
{
...
std::string constraint::get_dim_name(isl::checked::dim type, unsigned int pos) const
{
...
boolean constraint::involves_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
boolean constraint::is_lower_bound(isl::checked::dim type, unsigned int pos) const
{
  auto res = isl_constraint_is_lower_bound(get(), static_cast<enum isl_dim_type>(type), pos);
  return manage(res);
}

boolean constraint::is_upper_bound(isl::checked::dim type, unsigned int pos) const
{
...
constraint constraint::set_coefficient_si(isl::checked::dim type, int pos, int v) const
{
  auto res = isl_constraint_set_coefficient_si(copy(), static_cast<enum isl_dim_type>(type), pos, v);
  return manage(res);
}

constraint constraint::set_coefficient_val(isl::checked::dim type, int pos, val v) const
{
...
local_space local_space::add_dims(isl::checked::dim type, unsigned int n) const
{
  auto res = isl_local_space_add_dims(copy(), static_cast<enum isl_dim_type>(type), n);
  return manage(res);
}

int local_space::dim(isl::checked::dim type) const
{
...
local_space local_space::drop_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
  auto res = isl_local_space_drop_dims(copy(), static_cast<enum isl_dim_type>(type), first, n);
  return manage(res);
}

int local_space::find_dim_by_name(isl::checked::dim type, const std::string &name) const
{
...
id local_space::get_dim_id(isl::checked::dim type, unsigned int pos) const
{
  auto res = isl_local_space_get_dim_id(get(), static_cast<enum isl_dim_type>(type), pos);
  return manage(res);
}

std::string local_space::get_dim_name(isl::checked::dim type, unsigned int pos) const
{
...
boolean local_space::has_dim_id(isl::checked::dim type, unsigned int pos) const
{
  auto res = isl_local_space_has_dim_id(get(), static_cast<enum isl_dim_type>(type), pos);
  return manage(res);
}

boolean local_space::has_dim_name(isl::checked::dim type, unsigned int pos) const
{
  auto res = isl_local_space_has_dim_name(get(), static_cast<enum isl_dim_type>(type), pos);
  return manage(res);
}

local_space local_space::insert_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
local_space local_space::set_dim_id(isl::checked::dim type, unsigned int pos, id id) const
{
...
local_space local_space::set_tuple_id(isl::checked::dim type, id id) const
{
...
map map::add_dims(isl::checked::dim type, unsigned int n) const
{
...
unsigned int map::dim(isl::checked::dim type) const
{
...
map map::drop_constraints_involving_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
  auto res = isl_map_drop_constraints_involving_dims(copy(), static_cast<enum isl_dim_type>(type), first, n);
  return manage(res);
}

map map::drop_constraints_not_involving_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
map map::eliminate(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
map map::equate(isl::checked::dim type1, int pos1, isl::checked::dim type2, int pos2) const
{
...
int map::find_dim_by_id(isl::checked::dim type, const id &id) const
{
  auto res = isl_map_find_dim_by_id(get(), static_cast<enum isl_dim_type>(type), id.get());
  return res;
}

int map::find_dim_by_name(isl::checked::dim type, const std::string &name) const
{
  auto res = isl_map_find_dim_by_name(get(), static_cast<enum isl_dim_type>(type), name.c_str());
  return res;
}

map map::fix_si(isl::checked::dim type, unsigned int pos, int value) const
{
  auto res = isl_map_fix_si(copy(), static_cast<enum isl_dim_type>(type), pos, value);
  return manage(res);
}

map map::fix_val(isl::checked::dim type, unsigned int pos, val v) const
{
...
id map::get_dim_id(isl::checked::dim type, unsigned int pos) const
{
  auto res = isl_map_get_dim_id(get(), static_cast<enum isl_dim_type>(type), pos);
  return manage(res);
}

std::string map::get_dim_name(isl::checked::dim type, unsigned int pos) const
{
...
id map::get_tuple_id(isl::checked::dim type) const
{
  auto res = isl_map_get_tuple_id(get(), static_cast<enum isl_dim_type>(type));
  return manage(res);
}

std::string map::get_tuple_name(isl::checked::dim type) const
{
...
boolean map::has_dim_id(isl::checked::dim type, unsigned int pos) const
{
  auto res = isl_map_has_dim_id(get(), static_cast<enum isl_dim_type>(type), pos);
  return manage(res);
}

boolean map::has_dim_name(isl::checked::dim type, unsigned int pos) const
{
...
boolean map::has_tuple_id(isl::checked::dim type) const
{
  auto res = isl_map_has_tuple_id(get(), static_cast<enum isl_dim_type>(type));
  return manage(res);
}

boolean map::has_tuple_name(isl::checked::dim type) const
{
...
map map::insert_dims(isl::checked::dim type, unsigned int pos, unsigned int n) const
{
...
boolean map::involves_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
map map::lower_bound_si(isl::checked::dim type, unsigned int pos, int value) const
{
  auto res = isl_map_lower_bound_si(copy(), static_cast<enum isl_dim_type>(type), pos, value);
  return manage(res);
}

map map::move_dims(isl::checked::dim dst_type, unsigned int dst_pos, isl::checked::dim src_type, unsigned int src_pos, unsigned int n) const
{
...
val map::plain_get_val_if_fixed(isl::checked::dim type, unsigned int pos) const
{
...
map map::project_out(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
map map::remove_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
map map::remove_divs_involving_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
map map::reset_tuple_id(isl::checked::dim type) const
{
...
map map::set_dim_id(isl::checked::dim type, unsigned int pos, id id) const
{
  auto res = isl_map_set_dim_id(copy(), static_cast<enum isl_dim_type>(type), pos, id.release());
  return manage(res);
}

map map::set_tuple_id(isl::checked::dim type, id id) const
{
  auto res = isl_map_set_tuple_id(copy(), static_cast<enum isl_dim_type>(type), id.release());
  return manage(res);
}

map map::set_tuple_name(isl::checked::dim type, const std::string &s) const
{
...
map map::upper_bound_si(isl::checked::dim type, unsigned int pos, int value) const
{
...
multi_aff multi_aff::add_dims(isl::checked::dim type, unsigned int n) const
{
...
unsigned int multi_aff::dim(isl::checked::dim type) const
{
...
multi_aff multi_aff::drop_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
int multi_aff::find_dim_by_id(isl::checked::dim type, const id &id) const
{
  auto res = isl_multi_aff_find_dim_by_id(get(), static_cast<enum isl_dim_type>(type), id.get());
  return res;
}

int multi_aff::find_dim_by_name(isl::checked::dim type, const std::string &name) const
{
...
id multi_aff::get_dim_id(isl::checked::dim type, unsigned int pos) const
{
...
id multi_aff::get_tuple_id(isl::checked::dim type) const
{
  auto res = isl_multi_aff_get_tuple_id(get(), static_cast<enum isl_dim_type>(type));
  return manage(res);
}

std::string multi_aff::get_tuple_name(isl::checked::dim type) const
{
...
boolean multi_aff::has_tuple_id(isl::checked::dim type) const
{
...
multi_aff multi_aff::insert_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
  auto res = isl_multi_aff_insert_dims(copy(), static_cast<enum isl_dim_type>(type), first, n);
  return manage(res);
}

boolean multi_aff::involves_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
multi_aff multi_aff::move_dims(isl::checked::dim dst_type, unsigned int dst_pos, isl::checked::dim src_type, unsigned int src_pos, unsigned int n) const
{
...
multi_aff multi_aff::project_out_map(space space, isl::checked::dim type, unsigned int first, unsigned int n)
{
...
multi_aff multi_aff::reset_tuple_id(isl::checked::dim type) const
{
...
multi_aff multi_aff::set_dim_id(isl::checked::dim type, unsigned int pos, id id) const
{
  auto res = isl_multi_aff_set_dim_id(copy(), static_cast<enum isl_dim_type>(type), pos, id.release());
  return manage(res);
}

multi_aff multi_aff::set_tuple_id(isl::checked::dim type, id id) const
{
  auto res = isl_multi_aff_set_tuple_id(copy(), static_cast<enum isl_dim_type>(type), id.release());
  return manage(res);
}

multi_aff multi_aff::set_tuple_name(isl::checked::dim type, const std::string &s) const
{
...
multi_pw_aff multi_pw_aff::add_dims(isl::checked::dim type, unsigned int n) const
{
...
unsigned int multi_pw_aff::dim(isl::checked::dim type) const
{
...
multi_pw_aff multi_pw_aff::drop_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
int multi_pw_aff::find_dim_by_id(isl::checked::dim type, const id &id) const
{
  auto res = isl_multi_pw_aff_find_dim_by_id(get(), static_cast<enum isl_dim_type>(type), id.get());
  return res;
}

int multi_pw_aff::find_dim_by_name(isl::checked::dim type, const std::string &name) const
{
...
id multi_pw_aff::get_dim_id(isl::checked::dim type, unsigned int pos) const
{
...
id multi_pw_aff::get_tuple_id(isl::checked::dim type) const
{
  auto res = isl_multi_pw_aff_get_tuple_id(get(), static_cast<enum isl_dim_type>(type));
  return manage(res);
}

std::string multi_pw_aff::get_tuple_name(isl::checked::dim type) const
{
...
boolean multi_pw_aff::has_tuple_id(isl::checked::dim type) const
{
...
multi_pw_aff multi_pw_aff::insert_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
boolean multi_pw_aff::involves_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
multi_pw_aff multi_pw_aff::move_dims(isl::checked::dim dst_type, unsigned int dst_pos, isl::checked::dim src_type, unsigned int src_pos, unsigned int n) const
{
...
multi_pw_aff multi_pw_aff::reset_tuple_id(isl::checked::dim type) const
{
...
multi_pw_aff multi_pw_aff::set_dim_id(isl::checked::dim type, unsigned int pos, id id) const
{
...
multi_pw_aff multi_pw_aff::set_tuple_id(isl::checked::dim type, id id) const
{
  auto res = isl_multi_pw_aff_set_tuple_id(copy(), static_cast<enum isl_dim_type>(type), id.release());
  return manage(res);
}

multi_pw_aff multi_pw_aff::set_tuple_name(isl::checked::dim type, const std::string &s) const
{
...
unsigned int multi_union_pw_aff::dim(isl::checked::dim type) const
{
...
multi_union_pw_aff multi_union_pw_aff::drop_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
int multi_union_pw_aff::find_dim_by_id(isl::checked::dim type, const id &id) const
{
  auto res = isl_multi_union_pw_aff_find_dim_by_id(get(), static_cast<enum isl_dim_type>(type), id.get());
  return res;
}

int multi_union_pw_aff::find_dim_by_name(isl::checked::dim type, const std::string &name) const
{
...
id multi_union_pw_aff::get_dim_id(isl::checked::dim type, unsigned int pos) const
{
...
id multi_union_pw_aff::get_tuple_id(isl::checked::dim type) const
{
  auto res = isl_multi_union_pw_aff_get_tuple_id(get(), static_cast<enum isl_dim_type>(type));
  return manage(res);
}

std::string multi_union_pw_aff::get_tuple_name(isl::checked::dim type) const
{
...
boolean multi_union_pw_aff::has_tuple_id(isl::checked::dim type) const
{
...
multi_union_pw_aff multi_union_pw_aff::reset_tuple_id(isl::checked::dim type) const
{
...
multi_union_pw_aff multi_union_pw_aff::set_dim_id(isl::checked::dim type, unsigned int pos, id id) const
{
  auto res = isl_multi_union_pw_aff_set_dim_id(copy(), static_cast<enum isl_dim_type>(type), pos, id.release());
  return manage(res);
}

multi_union_pw_aff multi_union_pw_aff::set_tuple_id(isl::checked::dim type, id id) const
{
  auto res = isl_multi_union_pw_aff_set_tuple_id(copy(), static_cast<enum isl_dim_type>(type), id.release());
  return manage(res);
}

multi_union_pw_aff multi_union_pw_aff::set_tuple_name(isl::checked::dim type, const std::string &s) const
{
...
multi_val multi_val::add_dims(isl::checked::dim type, unsigned int n) const
{
...
unsigned int multi_val::dim(isl::checked::dim type) const
{
  auto res = isl_multi_val_dim(get(), static_cast<enum isl_dim_type>(type));
  return res;
}

multi_val multi_val::drop_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
int multi_val::find_dim_by_id(isl::checked::dim type, const id &id) const
{
  auto res = isl_multi_val_find_dim_by_id(get(), static_cast<enum isl_dim_type>(type), id.get());
  return res;
}

int multi_val::find_dim_by_name(isl::checked::dim type, const std::string &name) const
{
...
id multi_val::get_dim_id(isl::checked::dim type, unsigned int pos) const
{
...
id multi_val::get_tuple_id(isl::checked::dim type) const
{
  auto res = isl_multi_val_get_tuple_id(get(), static_cast<enum isl_dim_type>(type));
  return manage(res);
}

std::string multi_val::get_tuple_name(isl::checked::dim type) const
{
...
boolean multi_val::has_tuple_id(isl::checked::dim type) const
{
  auto res = isl_multi_val_has_tuple_id(get(), static_cast<enum isl_dim_type>(type));
  return manage(res);
}

multi_val multi_val::insert_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
  auto res = isl_multi_val_insert_dims(copy(), static_cast<enum isl_dim_type>(type), first, n);
  return manage(res);
}

boolean multi_val::involves_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
multi_val multi_val::reset_tuple_id(isl::checked::dim type) const
{
...
multi_val multi_val::set_dim_id(isl::checked::dim type, unsigned int pos, id id) const
{
  auto res = isl_multi_val_set_dim_id(copy(), static_cast<enum isl_dim_type>(type), pos, id.release());
  return manage(res);
}

multi_val multi_val::set_tuple_id(isl::checked::dim type, id id) const
{
  auto res = isl_multi_val_set_tuple_id(copy(), static_cast<enum isl_dim_type>(type), id.release());
  return manage(res);
}

multi_val multi_val::set_tuple_name(isl::checked::dim type, const std::string &s) const
{
...
point point::add_ui(isl::checked::dim type, int pos, unsigned int val) const
{
  auto res = isl_point_add_ui(copy(), static_cast<enum isl_dim_type>(type), pos, val);
  return manage(res);
}

val point::get_coordinate_val(isl::checked::dim type, int pos) const
{
...
point point::set_coordinate_val(isl::checked::dim type, int pos, val v) const
{
  auto res = isl_point_set_coordinate_val(copy(), static_cast<enum isl_dim_type>(type), pos, v.release());
  return manage(res);
}

point point::sub_ui(isl::checked::dim type, int pos, unsigned int val) const
{
...
pw_aff pw_aff::add_dims(isl::checked::dim type, unsigned int n) const
{
...
unsigned int pw_aff::dim(isl::checked::dim type) const
{
...
pw_aff pw_aff::drop_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
int pw_aff::find_dim_by_name(isl::checked::dim type, const std::string &name) const
{
...
id pw_aff::get_dim_id(isl::checked::dim type, unsigned int pos) const
{
  auto res = isl_pw_aff_get_dim_id(get(), static_cast<enum isl_dim_type>(type), pos);
  return manage(res);
}

std::string pw_aff::get_dim_name(isl::checked::dim type, unsigned int pos) const
{
...
id pw_aff::get_tuple_id(isl::checked::dim type) const
{
...
boolean pw_aff::has_dim_id(isl::checked::dim type, unsigned int pos) const
{
  auto res = isl_pw_aff_has_dim_id(get(), static_cast<enum isl_dim_type>(type), pos);
  return manage(res);
}

boolean pw_aff::has_tuple_id(isl::checked::dim type) const
{
  auto res = isl_pw_aff_has_tuple_id(get(), static_cast<enum isl_dim_type>(type));
  return manage(res);
}

pw_aff pw_aff::insert_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
boolean pw_aff::involves_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
pw_aff pw_aff::move_dims(isl::checked::dim dst_type, unsigned int dst_pos, isl::checked::dim src_type, unsigned int src_pos, unsigned int n) const
{
...
pw_aff pw_aff::reset_tuple_id(isl::checked::dim type) const
{
...
pw_aff pw_aff::set_dim_id(isl::checked::dim type, unsigned int pos, id id) const
{
  auto res = isl_pw_aff_set_dim_id(copy(), static_cast<enum isl_dim_type>(type), pos, id.release());
  return manage(res);
}

pw_aff pw_aff::set_tuple_id(isl::checked::dim type, id id) const
{
...
pw_aff pw_aff::var_on_domain(local_space ls, isl::checked::dim type, unsigned int pos)
{
...
unsigned int pw_multi_aff::dim(isl::checked::dim type) const
{
...
pw_multi_aff pw_multi_aff::drop_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
int pw_multi_aff::find_dim_by_name(isl::checked::dim type, const std::string &name) const
{
  auto res = isl_pw_multi_aff_find_dim_by_name(get(), static_cast<enum isl_dim_type>(type), name.c_str());
  return res;
}

pw_multi_aff pw_multi_aff::fix_si(isl::checked::dim type, unsigned int pos, int value) const
{
...
id pw_multi_aff::get_dim_id(isl::checked::dim type, unsigned int pos) const
{
  auto res = isl_pw_multi_aff_get_dim_id(get(), static_cast<enum isl_dim_type>(type), pos);
  return manage(res);
}

std::string pw_multi_aff::get_dim_name(isl::checked::dim type, unsigned int pos) const
{
...
id pw_multi_aff::get_tuple_id(isl::checked::dim type) const
{
  auto res = isl_pw_multi_aff_get_tuple_id(get(), static_cast<enum isl_dim_type>(type));
  return manage(res);
}

std::string pw_multi_aff::get_tuple_name(isl::checked::dim type) const
{
...
boolean pw_multi_aff::has_tuple_id(isl::checked::dim type) const
{
  auto res = isl_pw_multi_aff_has_tuple_id(get(), static_cast<enum isl_dim_type>(type));
  return manage(res);
}

boolean pw_multi_aff::has_tuple_name(isl::checked::dim type) const
{
...
boolean pw_multi_aff::involves_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
pw_multi_aff pw_multi_aff::project_out_map(space space, isl::checked::dim type, unsigned int first, unsigned int n)
{
...
pw_multi_aff pw_multi_aff::reset_tuple_id(isl::checked::dim type) const
{
...
pw_multi_aff pw_multi_aff::set_dim_id(isl::checked::dim type, unsigned int pos, id id) const
{
...
pw_multi_aff pw_multi_aff::set_tuple_id(isl::checked::dim type, id id) const
{
...
pw_qpolynomial pw_qpolynomial::add_dims(isl::checked::dim type, unsigned int n) const
{
...
unsigned int pw_qpolynomial::dim(isl::checked::dim type) const
{
...
pw_qpolynomial pw_qpolynomial::drop_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
int pw_qpolynomial::find_dim_by_name(isl::checked::dim type, const std::string &name) const
{
  auto res = isl_pw_qpolynomial_find_dim_by_name(get(), static_cast<enum isl_dim_type>(type), name.c_str());
  return res;
}

pw_qpolynomial pw_qpolynomial::fix_val(isl::checked::dim type, unsigned int n, val v) const
{
...
pw_qpolynomial pw_qpolynomial::insert_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
boolean pw_qpolynomial::involves_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
pw_qpolynomial pw_qpolynomial::move_dims(isl::checked::dim dst_type, unsigned int dst_pos, isl::checked::dim src_type, unsigned int src_pos, unsigned int n) const
{
...
pw_qpolynomial pw_qpolynomial::split_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
qpolynomial qpolynomial::add_dims(isl::checked::dim type, unsigned int n) const
{
...
unsigned int qpolynomial::dim(isl::checked::dim type) const
{
  auto res = isl_qpolynomial_dim(get(), static_cast<enum isl_dim_type>(type));
  return res;
}

qpolynomial qpolynomial::drop_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
qpolynomial qpolynomial::from_constraint(constraint c, isl::checked::dim type, unsigned int pos)
{
...
qpolynomial qpolynomial::insert_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
  auto res = isl_qpolynomial_insert_dims(copy(), static_cast<enum isl_dim_type>(type), first, n);
  return manage(res);
}

boolean qpolynomial::involves_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
qpolynomial qpolynomial::move_dims(isl::checked::dim dst_type, unsigned int dst_pos, isl::checked::dim src_type, unsigned int src_pos, unsigned int n) const
{
...
qpolynomial qpolynomial::var_on_domain(space dim, isl::checked::dim type, unsigned int pos)
{
...
set set::add_dims(isl::checked::dim type, unsigned int n) const
{
...
unsigned int set::dim(isl::checked::dim type) const
{
  auto res = isl_set_dim(get(), static_cast<enum isl_dim_type>(type));
  return res;
}

boolean set::dim_has_any_lower_bound(isl::checked::dim type, unsigned int pos) const
{
  auto res = isl_set_dim_has_any_lower_bound(get(), static_cast<enum isl_dim_type>(type), pos);
  return manage(res);
}

boolean set::dim_has_any_upper_bound(isl::checked::dim type, unsigned int pos) const
{
  auto res = isl_set_dim_has_any_upper_bound(get(), static_cast<enum isl_dim_type>(type), pos);
  return manage(res);
}

boolean set::dim_has_lower_bound(isl::checked::dim type, unsigned int pos) const
{
  auto res = isl_set_dim_has_lower_bound(get(), static_cast<enum isl_dim_type>(type), pos);
  return manage(res);
}

boolean set::dim_has_upper_bound(isl::checked::dim type, unsigned int pos) const
{
  auto res = isl_set_dim_has_upper_bound(get(), static_cast<enum isl_dim_type>(type), pos);
  return manage(res);
}

boolean set::dim_is_bounded(isl::checked::dim type, unsigned int pos) const
{
...
set set::drop_constraints_involving_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
  auto res = isl_set_drop_constraints_involving_dims(copy(), static_cast<enum isl_dim_type>(type), first, n);
  return manage(res);
}

set set::drop_constraints_not_involving_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
set set::eliminate(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
set set::equate(isl::checked::dim type1, int pos1, isl::checked::dim type2, int pos2) const
{
  auto res = isl_set_equate(copy(), static_cast<enum isl_dim_type>(type1), pos1, static_cast<enum isl_dim_type>(type2), pos2);
  return manage(res);
}

int set::find_dim_by_id(isl::checked::dim type, const id &id) const
{
  auto res = isl_set_find_dim_by_id(get(), static_cast<enum isl_dim_type>(type), id.get());
  return res;
}

int set::find_dim_by_name(isl::checked::dim type, const std::string &name) const
{
  auto res = isl_set_find_dim_by_name(get(), static_cast<enum isl_dim_type>(type), name.c_str());
  return res;
}

set set::fix_si(isl::checked::dim type, unsigned int pos, int value) const
{
  auto res = isl_set_fix_si(copy(), static_cast<enum isl_dim_type>(type), pos, value);
  return manage(res);
}

set set::fix_val(isl::checked::dim type, unsigned int pos, val v) const
{
...
id set::get_dim_id(isl::checked::dim type, unsigned int pos) const
{
  auto res = isl_set_get_dim_id(get(), static_cast<enum isl_dim_type>(type), pos);
  return manage(res);
}

std::string set::get_dim_name(isl::checked::dim type, unsigned int pos) const
{
...
boolean set::has_dim_id(isl::checked::dim type, unsigned int pos) const
{
  auto res = isl_set_has_dim_id(get(), static_cast<enum isl_dim_type>(type), pos);
  return manage(res);
}

boolean set::has_dim_name(isl::checked::dim type, unsigned int pos) const
{
...
set set::insert_dims(isl::checked::dim type, unsigned int pos, unsigned int n) const
{
...
boolean set::involves_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
set set::lower_bound_si(isl::checked::dim type, unsigned int pos, int value) const
{
  auto res = isl_set_lower_bound_si(copy(), static_cast<enum isl_dim_type>(type), pos, value);
  return manage(res);
}

set set::lower_bound_val(isl::checked::dim type, unsigned int pos, val value) const
{
...
set set::move_dims(isl::checked::dim dst_type, unsigned int dst_pos, isl::checked::dim src_type, unsigned int src_pos, unsigned int n) const
{
...
val set::plain_get_val_if_fixed(isl::checked::dim type, unsigned int pos) const
{
...
map set::project_onto_map(isl::checked::dim type, unsigned int first, unsigned int n) const
{
  auto res = isl_set_project_onto_map(copy(), static_cast<enum isl_dim_type>(type), first, n);
  return manage(res);
}

set set::project_out(isl::checked::dim type, unsigned int first, unsigned int n) const
{
  auto res = isl_set_project_out(copy(), static_cast<enum isl_dim_type>(type), first, n);
  return manage(res);
}

set set::remove_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
set set::remove_divs_involving_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
set set::set_dim_id(isl::checked::dim type, unsigned int pos, id id) const
{
...
set set::split_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
set set::upper_bound_si(isl::checked::dim type, unsigned int pos, int value) const
{
  auto res = isl_set_upper_bound_si(copy(), static_cast<enum isl_dim_type>(type), pos, value);
  return manage(res);
}

set set::upper_bound_val(isl::checked::dim type, unsigned int pos, val value) const
{
...
space space::add_dims(isl::checked::dim type, unsigned int n) const
{
...
unsigned int space::dim(isl::checked::dim type) const
{
...
space space::drop_dims(isl::checked::dim type, unsigned int first, unsigned int num) const
{
...
int space::find_dim_by_id(isl::checked::dim type, const id &id) const
{
  auto res = isl_space_find_dim_by_id(get(), static_cast<enum isl_dim_type>(type), id.get());
  return res;
}

int space::find_dim_by_name(isl::checked::dim type, const std::string &name) const
{
...
id space::get_dim_id(isl::checked::dim type, unsigned int pos) const
{
  auto res = isl_space_get_dim_id(get(), static_cast<enum isl_dim_type>(type), pos);
  return manage(res);
}

std::string space::get_dim_name(isl::checked::dim type, unsigned int pos) const
{
...
id space::get_tuple_id(isl::checked::dim type) const
{
  auto res = isl_space_get_tuple_id(get(), static_cast<enum isl_dim_type>(type));
  return manage(res);
}

std::string space::get_tuple_name(isl::checked::dim type) const
{
...
boolean space::has_dim_id(isl::checked::dim type, unsigned int pos) const
{
  auto res = isl_space_has_dim_id(get(), static_cast<enum isl_dim_type>(type), pos);
  return manage(res);
}

boolean space::has_dim_name(isl::checked::dim type, unsigned int pos) const
{
...
boolean space::has_tuple_id(isl::checked::dim type) const
{
  auto res = isl_space_has_tuple_id(get(), static_cast<enum isl_dim_type>(type));
  return manage(res);
}

boolean space::has_tuple_name(isl::checked::dim type) const
{
  auto res = isl_space_has_tuple_name(get(), static_cast<enum isl_dim_type>(type));
  return manage(res);
}

space space::insert_dims(isl::checked::dim type, unsigned int pos, unsigned int n) const
{
...
space space::move_dims(isl::checked::dim dst_type, unsigned int dst_pos, isl::checked::dim src_type, unsigned int src_pos, unsigned int n) const
{
...
space space::reset_tuple_id(isl::checked::dim type) const
{
...
space space::set_dim_id(isl::checked::dim type, unsigned int pos, id id) const
{
...
space space::set_tuple_id(isl::checked::dim type, id id) const
{
  auto res = isl_space_set_tuple_id(copy(), static_cast<enum isl_dim_type>(type), id.release());
  return manage(res);
}

space space::set_tuple_name(isl::checked::dim type, const std::string &s) const
{
  auto res = isl_space_set_tuple_name(copy(), static_cast<enum isl_dim_type>(type), s.c_str());
  return manage(res);
}

boolean space::tuple_is_equal(isl::checked::dim type1, const space &space2, isl::checked::dim type2) const
{
...
unsigned int term::dim(isl::checked::dim type) const
{
...
int term::get_exp(isl::checked::dim type, unsigned int pos) const
{
...
unsigned int union_map::dim(isl::checked::dim type) const
{
...
int union_map::find_dim_by_name(isl::checked::dim type, const std::string &name) const
{
...
id union_map::get_dim_id(isl::checked::dim type, unsigned int pos) const
{
...
boolean union_map::involves_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
union_map union_map::project_out(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
unsigned int union_pw_aff::dim(isl::checked::dim type) const
{
...
union_pw_aff union_pw_aff::drop_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
int union_pw_aff::find_dim_by_name(isl::checked::dim type, const std::string &name) const
{
...
unsigned int union_pw_multi_aff::dim(isl::checked::dim type) const
{
...
union_pw_multi_aff union_pw_multi_aff::drop_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
int union_pw_multi_aff::find_dim_by_name(isl::checked::dim type, const std::string &name) const
{
...
unsigned int union_pw_qpolynomial::dim(isl::checked::dim type) const
{
...
union_pw_qpolynomial union_pw_qpolynomial::drop_dims(isl::checked::dim type, unsigned int first, unsigned int n) const
{
...
int union_pw_qpolynomial::find_dim_by_name(isl::checked::dim type, const std::string &name) const
{
...
unsigned int union_set::dim(isl::checked::dim type) const
{
...
union_set union_set::project_out(isl::checked::dim type, unsigned int first, unsigned int n) const
{
