...
#define cudaCheckKernel() \
  ...
  cudaCheckReturn(cublasSetMatrix(1024, 1024, sizeof(int), D, 1024, dev_D, 1024));
  {
    dim3 k0_dimBlock(32);
    dim3 k0_dimGrid(64);
    kernel0 <<<k0_dimGrid, k0_dimBlock>>> (dev_B, alpha);
    cudaCheckKernel();
  }
  
  {
    ...
    kernel1 <<<k1_dimGrid, k1_dimBlock>>> (dev_A, dev_B, dev_D, alpha);
    cudaCheckKernel();
  }
  
  cudaCheckReturn(cudaGetMatrix(1024, 1024, sizeof(int), dev_B, 1024, B, 1024));
